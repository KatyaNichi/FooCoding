...
CREATE TABLE `todoitem` (
  ...
  PRIMARY KEY (`itemID`),
  KEY `listId` (`listId`),
  CONSTRAINT `todoitem_ibfk_1` FOREIGN KEY (`listId`) REFERENCES `todolist` (`listId`)
...
INSERT INTO `todoitem` VALUES (4,'Call grandma',3,1),(5,'How to stop time',5,0);
...
-- Dump completed on 2023-06-08 11:19:12
